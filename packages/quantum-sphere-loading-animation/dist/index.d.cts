 ...
 */
declare function QuantumWaveOrbital({ config, autoRandomize, className, onSphereClick, }: OrbitalSphereProps): react_jsx_runtime.JSX.Element;

export { type ColorScheme, type HoverEffects, type LineStyle, type OrbitalLine, type OrbitalSphereConfig, type OrbitalSphereProps, type OrbitalSphereState, QuantumWaveOrbital, type RandomFunction, type RandomIntFunction, type RandomRangeFunction, type SphereData, QuantumWaveOrbital as default };
