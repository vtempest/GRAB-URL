/**
 * @file downloader.ts
 * @description ColorFileDownloader — thin orchestrator class.
 *
 * All heavy logic lives in dedicated modules:
 *   Formatting    → ./download-format.ts
 *   Spinners      → ./download-spinners.ts
 *   State / resume → ./download-state.ts
 *   Keyboard      → ./download-keyboard.ts
 *   Single file   → ./download-single.ts
 *   Multi file    → ./download-multi.ts
 */
...
} from './download-keyboard.js';

import {
    downloadFile as _downloadFile,
    type SingleDownloadContext,
} from './download-single.js';
